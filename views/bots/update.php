<?php
    ...
    if ( isset($bot_success ) ) {
        ?><p>Your bot is correctly configured <img src='static/images/check.png' /></p><?php
    }
    else if ( isset( $bot_not_success ) ) {
        ?><p>Your bot is incorrectly configured <img src='static/images/cancel.png' /></p><?php
        if ( isset( $invalid_hostname ) ) {
